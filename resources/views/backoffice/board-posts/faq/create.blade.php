        ...
        <div class="board-card-body">
            ...
            <form action="{{ route('backoffice.board-posts.store', $board->slug ?? 'notice') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="board-form-group">
                    ...
                    <textarea class="board-form-control board-form-textarea" id="content" name="content" rows="15" data-backoffice-ckeditor @if($board->isFieldRequired('content')) required @endif>{{ old('content') }}</textarea>
                </div>
                @endif
